...
setup(
    ...
    description='PyNIRSPEC',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/bbenneke/pynirspec',

    # Author details
    author='',
    author_email='bbenneke@astro.umontreal.ca',
    ...
    install_requires=['emcee',"numpy (>=1.5)", "matplotlib", "scipy"],
